  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center text-white'>
        <div id='home' className='text-white h-[87vh]  xl:w-[1000px] md:mt-[20px] md:flex flex-row-reverse md:gap-x-[130px] justify-around'>
          ...
          <div className="text text-center mt-6 text-xl md:mt-40 md:text-left">
              ...
              <div className="flex-links flex flex-col md:flex-row gap-3">
                <Link to="contact" className='bg-purple-600 text-white text-[1rem] border-0 rounded-full px-4 py-2 transition-all duration-300 hover:bg-purple-700'>
                  Contact Me
                </Link>
                <Link to="about" className='text-white text-[1rem] rounded-full border-1 border-purple-600  px-4 py-2 transition-all duration-300 hover:bg-purple-700'>
                  About Me
                </Link>
              </div>
          </div>
